<template>
  <button
    :class="['base-button', ...baseButtonClassModifier]"
    :disabled="isDisabled"
    :type="type"
  >
...
const props = defineProps({
  ...
  variant: {
    ...
    default: "filled",
    validator: (value) =>
      ["filled", "outlined", "text"].includes(value.toLowerCase()),
  },
  size: {
    type: String,
    default: "medium",
...
const baseButtonClassModifier = useClassModifier(
  "base-button",
  baseButtonClassConditionMapper
);
</script>
